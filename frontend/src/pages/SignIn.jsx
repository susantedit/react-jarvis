...
import bg from "../assets/signnup.gif"
...
try {
 ...
 <form className='w-[90%] h-[600px] max-w-[500px] bg-[#00000062] rounded-[60px] backdrop-blur shadow-lg shadow-black flex flex-col items-center justify-center gap-[20px] px-[20px]' onSubmit={handleSignIn}>
...
{!showPassword && <IoEye className='absolute top-[18px] right-[20px] w-[25px] h-[25px] text-[white] cursor-pointer' onClick={()=>setShowPassword(true)}/>}
  ...
  {err.length>0 && <p className='text-red-600 font-semibold text-[17px]  mt-[30px] text-center px-4 py-1 rounded-full bg-gray-400/30 backdrop-blur-sm '>
                      *{err}
                    </p>}
